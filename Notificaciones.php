...
<html lang="es">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark" style="background-color: #003682;">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.html">Actividades</a>
            <!-- Sidebar Toggle-->
            ...
            <div id="layoutSidenav_nav">
                <nav class="sb-sidenav accordion sb-sidenav-dark" style="background-color: #003682;" id="sidenavAccordion">
                    <div class="sb-sidenav-menu"> 
                        <div class="nav">
                            <div class="sb-sidenav-menu-heading">Menú de Actividades</div>
                            ...
                            <a class="nav-link" href="Contactos.php" data-bs-toggle="collapse" data-bs-target="#collapseLayouts" aria-expanded="false" aria-controls="collapseLayouts">
                            ...
                            <a class="nav-link collapsed" href="Horario.php" data-bs-toggle="collapse" data-bs-target="#collapsePages" aria-expanded="false" aria-controls="collapsePages">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <p align="right"><img src=imagenes/Logo.png width="100px" height="100px"></p>
                    </div>
                </main>
